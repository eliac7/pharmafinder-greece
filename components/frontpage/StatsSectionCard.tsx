...
function StatsCard({ title, data, isLoading }: StatsProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center rounded-lg bg-white p-4 shadow-md transition duration-300 ease-in-out hover:bg-gray-300 dark:bg-gray-800 dark:hover:bg-gray-500">
      {isLoading ? (
